...
function HomepageHeader() {
  ...
  // useLayoutEffect(() => {
  //   axios
  //     .get("https://api.github.com/repos/p2devs/DekuFusion-Release/releases/latest")
  //     .then((response) => {
    ...
    <header>
      <div className={styles.container}>
        ...
        <div align="left">
          ...
          {/* <a
            href="https://github.com/p2devs/DekuFusion-Release/releases/latest"
            style={{
              marginRight: "10px",
              marginBottom: "10px",
            }}
          >
            <img
              ...
              src="https://img.shields.io/github/v/release/p2devs/DekuFusion-Release"
            />
          </a>
          <a
            href="https://github.com/p2devs/DekuFusion-Release/blob/main/LICENSE"
            style={{
              marginRight: "10px",
              marginBottom: "10px",
            }}
          >
            <img
              alt="GitHub"
              src="https://img.shields.io/github/license/p2devs/DekuFusion-Release"
            />
          </a> */}
        </div>
        {/* <h2 className={styles.subtitle}>{siteConfig.tagline}</h2> */}
        <h2 className={styles.subtitle}>DekuFusion coming soon...</h2>
        {/* <p className={styles.description}>
          DekuFusion is a free mobile app offering a vast collection of anime
          across genres like superheroes, sci-fi, fantasy. Enjoy a seamless
          experience with user-friendly navigation and customizable settings.
          Stay updated with the latest releases and classics. With DekuFusion,
          your favorite stories and characters are always at your fingertips.
        </p> */}
        ...
        {/* <div className={styles.disclaimer}>
          ...
          <ul>
            <li>
              DekuFusion only scrapes links from various websites, making it easier
              for users to find anime and comics.
            </li>
            <li>
              Neither DekuFusion nor its developers/staff host any of the content
              found within the app. All images and anime/comic information in
              the app are sourced from various public APIs.
            </li>
            <li>
              Additionally, all anime/comic links in DekuFusion are obtained from
              various third-party anime hosting websites.
            </li>
            <li>
              DekuFusion and its owners aren't liable for any misuse of the content
              found inside or outside the app and cannot be held accountable for
              the distribution of any content found within the app.
            </li>
            <li>
              By using DekuFusion, you agree that the developers are not
        ...
        <div className={styles.contact}>
          ...
          <ul>
            <li>
              Email:{" "}
              <a href="mailto:dekufusion@p2devs.engineer">
                dekufusion@p2devs.engineer
              </a>{" "}
            </li>
            <li>
              Discord: Join our{" "}
            ...
            <li>
              ...
              <a href="https://github.com/p2devs/DekuFusion-Release/discussions">
                {" "}
        ...
        <div className={styles.license}>
          <h2>License</h2>
          <p>
            DekuFusion is licensed under the{" "}
            <a href="https://github.com/p2devs/DekuFusion-Release/blob/main/LICENSE">
              {" "}
              GNU GPLv3
            </a>
            .
